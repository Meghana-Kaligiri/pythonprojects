...
root = Tk()
root.title('Thinkchamp Youtube Video Downloader')
root.geometry('700x200')
root.resizable(0, 0)
root.config(bg='Coral')

# Heading label
Label(root, text='Thinkchamp Youtube Video Downloader', font=("Comic Sans MS", 15), bg='Coral').place(relx=0.25, rely=0.0)
